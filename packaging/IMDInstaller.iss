...
begin
  ...
  if not LoadStringFromFile(ExpandConstant('{app}\config.sample.yaml'), ConfigText) then
    Exit;
  ...
  StringChangeEx(ConfigText, 'https://docs.google.com/spreadsheets/d/SEU_ID/export?format=csv&gid=0', SheetUrl, True);
  StringChangeEx(ConfigText, 'C:/Users/SEU_USUARIO/Music/google', MusicDir, True);
  StringChangeEx(ConfigText, 'C:/Users/SEU_USUARIO/Music', StateDir, True);
